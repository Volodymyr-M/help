...
Ingantt stores your project files in Google Drive so you can access them from any device.

## Sign in to Google

When you first use Ingantt, you are asked to sign in with your Google account. Ingantt requests the following permissions:
